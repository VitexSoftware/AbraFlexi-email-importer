...
class ConvertorTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testdomCustomerToArray(): void
    {
        $this->assertEquals([
     ...
     */
    public function testgetInvoiceSuplier(): void
    {
        $this->assertEquals([
            'nazev' => 'SPOJE.NET s.r.o.',
            'ulice' => 'Závěrka 473/8',
     ...
     */
    public function testdomTaxTotalToArray(): void
    {
     ...
     */
    public function testdomInvoiceToArray(): void
    {
        $this->assertEquals([
     ...
     */
    public function testinvoiceSuplier(): void
    {
        $this->assertEquals([
            'nazev' => 'SPOJE.NET s.r.o.',
            'ulice' => 'Závěrka 473/8',
     ...
     */
    public function testinvoiceCustomer(): void
    {
        $this->assertEquals([
            'nazev' => 'Vítězslav Dvořák',
            'ulice' => 'Tehovská 642/3',
     ...
     */
    public function testinvoiceInfo(): void
    {
        $this->assertEquals([
            'id' => 'ext:fc:VF1-6877/2020',
            'cisDosle' => 'VF1-6877/2020',
     ...
     */
    public function testdomPaymentMeansToArray(): void
    {
