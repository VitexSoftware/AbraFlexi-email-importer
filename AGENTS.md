# AGENTS.md - Working AI Reference for AbraFlexi-email-importer

## Project Overview
**Type**: PHP Project/Debian Package
**Purpose**: AbraFlexi Email Importer
**Status**: Active
**Repository**: git@github.com:VitexSoftware/AbraFlexi-email-importer.git
